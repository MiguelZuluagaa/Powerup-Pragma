package com.pragma.powerup.plazoletamicroservice.configuration.security.jwt;
...
public class JwtTokenFilter extends OncePerRequestFilter {
    ...
    private List<String> excludedPrefixes = Arrays.asList("/auth/**", "/swagger-ui/**", "/actuator/**", "/restaurant/", "/dish/");
    ...
    protected void doFilterInternal(HttpServletRequest req, HttpServletResponse res, FilterChain filterChain)
        ...
        if (token != null && jwtProvider.validateToken(token)) {
            ...
            UserDetails userDetails = usuarioDetailsService.loadUserByUsername(nameUser);
